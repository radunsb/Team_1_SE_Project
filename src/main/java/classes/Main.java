...
public class Main {
     ...
     */
    public static Student craftUser(Scanner s) throws IOException {
        //ask for ID
        int id = 0;
        while (true) {
            try {
    ...
    public static void navigateSchedules(Scanner s, Student current) throws IOException {
        ...
        while (!state.equals("6")) {
            ...
            if (state.equals("1")) {
                ...
                System.out.println("This schedule current name is " + currentSchedule.getScheduleName());
     ...
     */
    private static void searchCourses() throws IOException {
        //User input setup
        Scanner input = new Scanner(System.in);
        String query = "";
     ...
     */
    static void readCSV() throws IOException, ParseException {
